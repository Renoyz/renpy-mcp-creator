...
def test_generation_tab_exposes_ai_and_upload_asset_entries(
    ...
    expect(page.get_by_role("columnheader", name="Thumbnail").first).to_be_visible(timeout=10000)
    expect(page.get_by_role("columnheader", name="Description").first).to_be_visible(timeout=10000)
    expect(page.get_by_role("columnheader", name="Prompt").first).to_be_visible(timeout=10000)
    expect(page.get_by_role("columnheader", name="AI Generate").first).to_be_visible(timeout=10000)
    expect(page.get_by_role("columnheader", name="Upload Image").first).to_be_visible(timeout=10000)
    ...
    expect(char_slot.get_by_role("button", name="Regenerate")).to_be_visible(timeout=10000)
    expect(char_slot.get_by_label("Manual Upload")).to_be_visible(timeout=10000)
    expect(char_slot.get_by_label("Alice normal prompt")).to_have_value("ink vampire hunter sprite")
    expect(bg_slot.get_by_role("button", name="Regenerate")).to_be_visible(timeout=10000)
    expect(bg_slot.get_by_label("Manual Upload")).to_be_visible(timeout=10000)
